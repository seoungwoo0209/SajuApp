...
function runAll(){
  ...
  try{
    ...
    const bestEl = ensureChipsContainer("best") || $("bestYears");
    const worstEl = ensureChipsContainer("worst") || $("worstYears");
    ...
    // 대운/세운 아코디언
    const lifeRoot = ensureLifeAccordionRoot() || $("lifeAccordion");
    if(lifeRoot){
      const ctx = {
