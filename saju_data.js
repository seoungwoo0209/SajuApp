...
// saju_core.js에서 이미 정의된 상수들을 가져와서 통합
(function() {
    ...
    Object.keys(HIDDEN_STEMS_BRANCH).forEach(branch => {
      ...
      window.SajuData.HIDDEN_STEMS_RATIO[branch] = stems.map(item => ({
        ...
        ratio: stems.length === 1 ? 1.0 : (
          stems.length === 2 && item.role === "여기" ? 0.7 :
          stems.length === 2 && item.role === "정기" ? 0.3 :
...
// 지장간 역할 (여기/중기/정기)
const HIDDEN_STEMS_ROLE = {
  "子": [{ stem: "癸", role: "여기" }],
  "丑": [{ stem: "己", role: "여기" }, { stem: "癸", role: "중기" }, { stem: "辛", role: "정기" }],
  "寅": [{ stem: "甲", role: "여기" }, { stem: "丙", role: "중기" }, { stem: "戊", role: "정기" }],
  "卯": [{ stem: "乙", role: "여기" }],
  "辰": [{ stem: "戊", role: "여기" }, { stem: "乙", role: "중기" }, { stem: "癸", role: "정기" }],
  "巳": [{ stem: "丙", role: "여기" }, { stem: "戊", role: "중기" }, { stem: "庚", role: "정기" }],
  "午": [{ stem: "丁", role: "여기" }, { stem: "己", role: "정기" }],
  "未": [{ stem: "己", role: "여기" }, { stem: "丁", role: "중기" }, { stem: "乙", role: "정기" }],
  "申": [{ stem: "庚", role: "여기" }, { stem: "壬", role: "중기" }, { stem: "戊", role: "정기" }],
  "酉": [{ stem: "辛", role: "여기" }],
  "戌": [{ stem: "戊", role: "여기" }, { stem: "辛", role: "중기" }, { stem: "丁", role: "정기" }],
  "亥": [{ stem: "壬", role: "여기" }, { stem: "甲", role: "정기" }]
};
